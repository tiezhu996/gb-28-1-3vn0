...
3. **在线考试**：倒计时、题目导航快速跳转、标记稍后作答、最后 5 分钟提醒、时间到自动提交；作答停顿自动保存草稿，刷新或换设备重进恢复答案、剩余时间与当前题号（版本号防乱序覆盖，仅本人进行中且未到截止时间的答卷可保存）。
...
| PUT | /exam-records/:id/autosave | 学生 | 自动保存答卷草稿（断点续答，版本号防乱序） |
